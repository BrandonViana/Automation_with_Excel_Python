...
def transferir_infos_aba(aba_origem, aba_destino, linha_origem):
...
aba_basededados = arquivo_bairros["Base de Dados"]

ultima_Linha = aba_basededados.max_row
#print(ultima_Linha)

estilos_cabecalho = copy(aba_basededados["A1"]._style)

for linha in range(2, ultima_Linha + 1):
  bairro = aba_basededados.cell(row= linha, column=3).value 
  if not bairro:
    break
  ...
  transferir_infos_aba(aba_basededados, aba_destino, linha)
